...
public class Student_Registration_WA_AfterSchoolPage_013 
{
	WebDriver ldriver;
	public Student_Registration_WA_AfterSchoolPage_013 (WebDriver rdriver)
	{
		ldriver = rdriver;
	...
	//Program Details Page(Previous) After school program=====================
	@FindBy (how=How.ID, using = "previous")
	@CacheLookup
	...
	public void clickNextRegistrant_Next()
	{
	...
	public void setMedicalYear()
	{
		...
		drop_MedicalYear5.selectByVisibleText("2020");
	}
